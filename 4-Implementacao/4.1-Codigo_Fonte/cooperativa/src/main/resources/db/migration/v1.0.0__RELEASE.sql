...
ALTER TABLE usuario ADD CONSTRAINT FK_usuario_associado FOREIGN KEY (id_associado) REFERENCES associado (id_associado);
...
ALTER TABLE associado ADD CONSTRAINT PK_associado PRIMARY KEY (id_associado);
...
ALTER TABLE famarcia ADD CONSTRAINT FK_famarcia_associado FOREIGN KEY (id_associado) REFERENCES associado (id_associado);
